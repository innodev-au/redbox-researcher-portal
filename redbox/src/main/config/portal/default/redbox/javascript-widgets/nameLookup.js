...
(function() {
    ...
    var displayNameLookups = function(json, position, queryTerm, callback,
        ...
        var nlaEnabled = nlaUrl.length > 0;
        
        var loaderGif = $(".nameLookup-progress").html();
        var tabbedDiv = $("<div><ul><li><a href=\"#mintLookupDialog\">Mint</a></li>" + (nlaEnabled ? "<li><a href=\"#nlaLookupDialog\">NLA<span class=\"nlaLookup-progress\"> "+loaderGif+"</span></a></li>" : "") + "</ul></div>");

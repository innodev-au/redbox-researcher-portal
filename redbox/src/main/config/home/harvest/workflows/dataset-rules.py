...
class IndexData:
    ...
    def __metadata(self):
        ...
        self.relationDict = {}
        self.customFields = {}
        self.researcherSubmission = None
    ...
    def __workflow(self):
        ...
        isReseracherSubmission = self.__getJsonPayload(self.packagePid).getBoolean(False, ["researcherSubmission"])
        
        if self.owner == "guest":
            raise SecurityException("You must be logged in to submit a dataset")
